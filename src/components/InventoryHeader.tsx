...
export default function InventoryHeader({ activeTab, setActiveTab, userEmail, roleLabel = '재고관리자', showTabs = true }: {
  activeTab: string
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base opacity-70">사무처 시설관리팀 · 재고관리</p>
              <h1 className="text-xl font-bold leading-tight">건축물관리용품 재고관리 시스템</h1>
            </div>
          </div>
